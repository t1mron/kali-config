...
apt update
apt full-upgrade
apt install mc vim tmux git mosh ufw xrdp software-properties-common rclone fail2ban cryptsetup transmission-cli transmission-common transmission-daemon dkms 
