...
apt update
apt full-upgrade
apt install mc tmux git mosh ufw software-properties-common rclone fail2ban cryptsetup transmission-cli transmission-common transmission-daemon dkms hostapd udhcpd
touch ~/.hushlogin
```
